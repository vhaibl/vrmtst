            ...
            "change_history": [
                {
                    ...
                    "dt_created": "2021-03-08T00:00:00+03:00",
                },
            ],
        }
...
def test_refuse_shift_by_employee(tz, employee_api, make_shift):
    ...
    # shift.assign_employee(employee_api.employee, employee_api.user)  # это метод для user
    employee_api.put(f"/api/v1/shifts/{shift.id}/book/")               # а это для employee
